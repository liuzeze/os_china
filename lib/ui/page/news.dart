...
class _NewsState extends State<News> {
  var data2 = [
    ...
    BannerDataBean(
        title: '掘金小册',
        url:
            'https://b-gold-cdn.xitu.io/v3/static/img/android.fef4da1.png'),
    BannerDataBean(
        title: '注意：Java 中的泛型信息是编译时的，泛型信息在运行时是不纯在的。。',
        url:
            'http://pic.nipic.com/2008-02-21/2008221193244277_2.jpg'),
    BannerDataBean(
        title: 'Flutter的设计思想就是完全的widget化。',
        url:
            'http://thumb102.hellorf.com/preview/115044886.jpg'),
  ];
